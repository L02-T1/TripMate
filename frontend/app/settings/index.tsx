    ...
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.card}>
          ...
          <SettingRow icon="cash-outline" label="Currency" value={user?.currency || 'VND — Vietnamese Đồng'} onPress={() => router.push('/settings/currency')} />
          <View style={styles.divider} />
          <SettingRow icon="location-outline" label="Default location" value={user?.defaultLocation || 'Đồng Hoa, Hồ Chí Minh'} onPress={() => router.push('/settings/location')} />
        </View>
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.divider} />
          <SettingRow icon="calendar-outline" label="Trip date format" value={user?.dateFormat || 'DD/MM/YYYY'} onPress={() => router.push('/settings/dateformat')} />
        </View>
      </View>
